...
public class SimpsonsRule {
	...
	/**
	 * Copied from http://www.javaworld.com/article/2092260/java-se/java-programming-with-lambda-expressions.html
	...
	public static double integrateV2(DoubleFunctionV2 df2, double a, double b,  int n) {
		if (n < 0 || n > 100_000) {
			String message = n + "out of range";
			throw new IllegalArgumentException(message);
		} else if (b < a) {
